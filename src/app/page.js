...
export default function Home() {
  return (
    <>
      ...
      <div className="  w-full p-2 text-center bg-gray-900 text-gray-300">Devloped by our friends at U. V. Patel College of Engineering - Mehsana <a href="https://linktr.ee/codingarpan" className="text-orange-400">CodingArpan &  Fenil Modi</a> </div>
    </>
  )
}
